...
from reviewer.agent import root_agent
...
def main():
    ...
    print("\nSending test query...")
    test_message = (
        """ Analyze the course content and categorize it into one of the predefined clusters: "
        "Blockchain Development, Web3 Business, Ecosystem and Community, "
        """
    )
